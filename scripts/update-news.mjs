...
const sourceTasks = [
  ...
  { id: 'matese-instagram-public', team: 'matese', label: 'Post Instagram Matese già registrati', url: 'https://www.instagram.com/polisportivamatese/', mode: 'direct', run: mateseInstagramNews },
